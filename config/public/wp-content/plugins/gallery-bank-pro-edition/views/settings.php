<?php
global $wpdb, $current_user,$wp_version,$foobox;
...
if (count($album_css) != 0) {
			...
			<div class="layout-span12">
				...
				<div class="widget-layout">
					...
					<div class="widget-layout-body">
						...
						<div id="settings_success_message" class="message green" style="display: none;">
							<span>
								<strong><?php _e("Settings has been updated.", gallery_bank); ?></strong>
							</span>
						</div>
						<div class="message green" id="restore_success_message" style="display: none;">
							<span>
    ...
    jQuery("#global_settings").validate
    ({
        rules: {
            ux_image_width: {
                required: true,
