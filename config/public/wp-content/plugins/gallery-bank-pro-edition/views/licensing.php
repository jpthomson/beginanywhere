...
<form id="gallery_bank_licensing" class="layout-form" method="post">
    <div class="fluid-layout">
        <div class="layout-span12">
            ...
            <div class="message green" id="licensing_success_message" style="display: none;margin-bottom: 10px;">
				<span>
					<strong id="licensing_message"></strong>
				</span>
            </div>
            <div class="message red" id="error_licensing_message" style="display: none;margin-bottom: 10px;">
				<span>
