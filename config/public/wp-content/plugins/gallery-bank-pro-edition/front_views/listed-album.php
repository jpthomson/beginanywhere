	    ...
	    <div class="list_album_content_div<?php echo $unique_id; ?>" id="ux_main_div<?php echo $unique_id; ?>">
			<div class="gallery-bank-hover-details">
	            ...
	            else
	            {
	                ?>
	                <div class="imgLiquid dynamic_cover_css"
	                 onclick="view_listed_slideshow_images<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)">
	                <?php
	            }
...
<?php
    ...
    if ($gallery_type != "slideshow") {
        ...
        <div id="bank_album_images_div<?php echo $unique_id; ?>" style="display: none;">
	    	...
	    	{
	    		?>
	    		<div id="show_bank_album_images<?php echo $unique_id; ?>" style="margin-top: 5px; text-align: center;">
				</div>
	    		<?php
			}
			else
    ...
    <?php
        ...
        ?>
        <div id="list_slideshow_images_div<?php echo $unique_id; ?>" style="display:none;">
        </div>
    <?php
    }
    ?>
