	...
	<div class="fluid-layout responsive">
		...
		<div class="layout-span12" style="padding:15px 15px 0 0;">
			...
			<div class="layout-control-group" id="div_img_width" style="display: none;">
			    ...
			    <input type="text" class="layout-span9" name="ux_img_width" id="ux_img_width" onkeypress="return OnlyNumbers(event);"
			           value="600"/>
			</div>
			...
			<div class="layout-control-group" id="div_special_effects">
			    ...
			    <select id="ux_special_effects" class="layout-span9" onchange="effects_settings();">
			...
			<div class="layout-control-group" id="rotation_setting" style="display: none;">
			    ...
			    <select id="ux_rotation" class="layout-span4">
			...
			<div class="layout-control-group" id="overlay_color" style="display: none;">
			    ...
			    <select id="ux_overlay_color" class="layout-span4">
			...
			<div class="layout-control-group" id="ribbon_color_with_direction" style="display: none;">
			    ...
			    <select id="ux_ribbon_color" class="layout-span3" style="margin-left: 14px;">
			        <option value="white">White</option>
			        <option value="black">Black</option>
			    </select>
			    <label class="custom-layout-label">From</label>
			...
			<div class="layout-control-group" id="lomo_effect_div" style="display: none;">
			    ...
			    <select id="ux_lomo_dir" class="layout-span4">
			...
			<div class="layout-control-group" id="rounded_images_div" style="display: none;">
			    ...
			    <select id="ux_rounded_images" class="layout-span4">
			...
			<div class="layout-control-group" id="div_animation_effects">
			    ...
			    <select id="ux_animation_effects" class="layout-span9">
...
function InsertGallery() {
    ...
    if (gallery_type == 1) {
        if (album_format == "individual") {
            if (gallery_format == "thumbnail" || gallery_format == "masonry") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" "+responsive+" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
            }
            else if (gallery_format == "filmstrip") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" album_id=\"" + album_id + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" album_id=\"" + album_id + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" album_id=\"" + album_id + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "slideshow") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
            }
            else if (gallery_format == "blog") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
                }
            }
        }
            ...
            if (gallery_format == "thumbnail" || gallery_format == "masonry") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" "+responsive+" albums_in_row=\"" + album_in_row + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" "+responsive+" albums_in_row=\"" + album_in_row + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" "+responsive+" albums_in_row=\"" + album_in_row + "\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "slideshow") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" albums_in_row=\"" + album_in_row + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" albums_in_row=\"" + album_in_row + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" albums_in_row=\"" + album_in_row + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "filmstrip") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" img_in_row=\"" + images_in_row + "\" albums_in_row=\"" + album_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" img_in_row=\"" + images_in_row + "\" albums_in_row=\"" + album_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" img_in_row=\"" + images_in_row + "\" albums_in_row=\"" + album_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "blog") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" albums_in_row=\"" + album_in_row + "\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" albums_in_row=\"" + album_in_row + "\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" albums_in_row=\"" + album_in_row + "\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
        }
        else {
            if (gallery_format == "thumbnail" || gallery_format == "masonry") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" "+responsive+" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "slideshow") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "filmstrip") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
            else if (gallery_format == "blog") {
                if (text_format == "title_only") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "title_desc") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
                else if (text_format == "no_text") {
                    window.send_to_editor("[gallery_bank type=\"" + album_format + "\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\"]");
                }
            }
        }
    }
        ...
        if (gallery_format == "thumbnail" || gallery_format == "masonry") {
            if (text_format == "title_only") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "title_desc") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" "+responsive+" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "no_text") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" "+responsive+" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
        }
        else if (gallery_format == "filmstrip") {
            if (text_format == "title_only") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "title_desc") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "no_text") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" img_in_row=\"" + images_in_row + "\" animation_effect=\"" + animation_effects + "\" image_width=\"" + filmstrip_width + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
        }
        else if (gallery_format == "blog") {
            if (text_format == "title_only") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "title_desc") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"true\" desc=\"true\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
            else if (text_format == "no_text") {
                window.send_to_editor("[gallery_bank type=\"images\" format=\"" + gallery_format + "\" title=\"false\" desc=\"false\" special_effect=\"" + gallery_effect + "\" animation_effect=\"" + animation_effects + "\" album_title=\"" + displayAlbumTitle + "\" album_id=\"" + album_id + "\"]");
            }
        }
    }
}
