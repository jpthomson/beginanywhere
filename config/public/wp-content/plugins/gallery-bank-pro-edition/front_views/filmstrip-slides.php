<div class="gallery-bank" style="text-align:center">
	<div class="img<?php echo $unique_id; ?> bottom_overlay" id="image<?php echo $unique_id; ?>">
	    ...
	    if ($pics[0]->video != 1) {
	        ?>
	        <img class="dynamic_css animated <?php echo $animation_effect;?>"
	             src="<?php echo stripcslashes(GALLERY_BK_THUMB_URL . $pics[0]->thumbnail_url); ?>">
	    <?php
	    }
	    ?>
	...
	<ul class="thumbs clearfix" id="thumb_<?php echo $unique_id; ?>">
	        ...
	        for ($flag = 0; $flag < count($pics); $flag++) {
	            ...
	            <div class="imgFilmstripFill opactiy_thumbs">
	                ...
	                if ($pics[$flag]->video == 1) {
	                    ?>
	                    <img data-desc="<?php echo $image_description; ?>" data-title="<?php echo $image_title; ?>" picPath=""
	                     imgpath="<?php echo $pics[$flag]->pic_name; ?>" type="video"
	                         src="<?php echo stripcslashes($pics[$flag]->thumbnail_url); ?>"/>
	                <?php
	                } else {
	                    ?>
	                    <img type="image" data-desc="<?php echo $image_description; ?>"
	                       picPath="<?php echo $pics[$flag]->thumbnail_url;?>" data-title="<?php echo $image_title; ?>" id="ux_img_div_<?php echo $unique_id; ?>"
	    ...
	    <li class="btns">
	        <span id="nxt_<?php echo $unique_id; ?>" class="filmstrip_next"></span>
	    </li>
	</ul>
