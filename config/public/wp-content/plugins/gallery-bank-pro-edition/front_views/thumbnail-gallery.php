	...
	switch($effect[0])
	{
		...
		case "corner_ribbons":
			...
			.corner_ribbon .corner_ribbon_top_left_black .corner_zoom {
				...
				left:-30px;
				/*top:-<?php echo $thumbnails_height + 20;?>px;
				left:-<?php echo $thumbnails_width - 115;?>px;*/
			}
			...
			.corner_ribbon .corner_ribbon_top_right_black .corner_zoom {
				...
				right:-30px;
				/*top:-<?php echo $thumbnails_height + 20;?>px;
				right:-<?php echo $thumbnails_width - 120;?>px;*/
			}
			...
			.corner_ribbon .corner_ribbon_bottom_right_black .corner_zoom {
				bottom:-<?php echo (($thumbnails_height^2)+(($thumbnails_width)^2))/2;?>px !important;
				right:-20px;
				/*bottom:-<?php echo $thumbnails_height + 20;?>px;
				right:-<?php echo $thumbnails_width - 120;?>px;*/
			}
			<?php
		break;
        ...
        switch ($lightbox_type)
		{
			case "pretty_photo":
				if( $pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					...
					{
						?>
						<a rel="<?php echo $unique_id;?>prettyPhoto[gallery]" 
			...
			case "photo_swipe":
				if( $pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					if($pics[$flag]->video == 1)
					{
						...
						<a class="<?php echo str_replace(","," ", $class); ?>" 
							href="<?php echo stripcslashes($pics[$flag]->pic_name); ?>"
							 target="_blank" id="ux_img_div_<?php echo $unique_id;?>">
						<?php
					}
					else
					{
			...
			case "GB_lightbox":
				if( $pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					if($pics[$flag]->video == 1)
					{
						...
						<a imgpath="<?php echo $pics[$flag]->pic_name; ?>"
							 class="<?php echo str_replace(","," ", $class)." ".$class_gb; ?>" href="javascript:void(0);"
							  data-title="<?php echo $photoswipe_title;?>" desc = "<?php echo $photoswipe_description; ?>"
				...
				else 
				{
					?>
					<a imgpath="<?php echo $pics[$flag]->thumbnail_url; ?>"
						 class="<?php echo str_replace(","," ", $class)." ".$class_gb; ?>"
						  href="<?php echo $pics[$flag]->url; ?>" id="ux_img_div_<?php echo $unique_id;?>" 
						  target="<?php echo $url_redirect; ?>" data-title="<?php echo $photoswipe_title;?>" desc = "<?php echo $photoswipe_description; ?>">
					<?php
				}
			break;
		}
			...
			<div class="dynamic_css margin_thumbs thumbnail_width<?php echo $unique_id;?> widget_margin_thumbs<?php echo $unique_id;?> gb_overlay">
				<div class="widgetImgLiquidFill<?php echo $unique_id;?> imgLiquidFill opactiy_thumbs">
					...
					<?php
						...
						{
							?>
							<img alt="<?php echo $image_title.$image_description;?>" imageid="<?php echo $pics[$flag]->pic_id;?>" id="ux_gb_img_<?php echo $unique_id;?>"
