...
switch ($album_type) {
    case "images":
        ...
        $lightbox_overlay_color = hex2rgb($lightbox_overlay_bg_color);
...
if (($album_type == "images" || $gallery_type == "slideshow"))
{
	...
	?>
		<div class="gb_container" id="gb_lightbox_container_div">
			...
			{
				?>
				<div class="gb_social_icons_holder">
					<div class="addthis_toolbox addthis_default_style" addthis:url=""
					 addthis:title="" addthis:description="">
						<a class="addthis_button_facebook_like" fb:like:layout="button_count"></a>
						<a class="addthis_button_tweet" style="width: 86px;"></a>
						<a class="addthis_button_pinterest_pinit" pi:pinit:layout="button_count" style="width: 53px;"></a>
						<a class="addthis_counter addthis_pill_style"></a>
					</div>
					<script type="text/javascript">var addthis_config = {"data_track_addressbar":true};</script>
					<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-530c6dae75f6cd04"></script>
				</div>
				<?php
			}
			else
			...
			?>
				<div class="gb_content_holder" id="contentHolderDiv">
					...
					<ul class="gb_social_div">
						<div id="social_div" class="addthis_toolbox addthis_default_style" addthis:url=""
						 addthis:title="" addthis:description="">
							<a class="addthis_button_facebook_like" fb:like:layout="button_count" style="width: 87px;"></a>
							<a class="addthis_button_tweet" style="width: 86px;"></a>
							<a class="addthis_button_pinterest_pinit" pi:pinit:layout="button_count" style="width: 53px;"></a>
							<a class="addthis_counter addthis_pill_style"></a>
						</div>
            ...
            <div class="thumbs-fluid-layout">
                <div class="gallery-bank-filter" style="margin-bottom: 60px;">
                    <div class="gallery-bank-filter-categories" id="bank_filters_<?php echo $unique_id; ?>">
                        <a href="#" id="gallery_filter_<?php echo $unique_id; ?>" class="act"
                           data-filter="*"><?php _e("VIEW ALL", gallery_bank); ?></a>
                        <?php
