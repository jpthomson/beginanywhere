	...
	for ($flag = 0;$flag < count($album);$flag++)
	{
    	...
    	<div class="albums_margin">
	        ...
	        if ($gallery_type == "slideshow")
	        {
				...
				onclick="getalbum_id<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)">
				<?php
			}
			else
			{
...
if ($gallery_type == "slideshow") {
    ?>
    <div id="bank_slideshow_images_div<?php echo $unique_id; ?>" style="display:none;">
    </div>
<?php
} else {
    ?>
