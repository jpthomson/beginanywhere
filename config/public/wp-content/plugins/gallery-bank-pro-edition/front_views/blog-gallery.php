		...
		switch ($lightbox_type)
		{
			case "pretty_photo":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					...
					{
						?>
						<a rel="<?php echo $unique_id;?>prettyPhoto[gallery]" class="<?php echo str_replace(",", " ", $class); ?>" 
				...
				{
					?>
					<a class="<?php echo str_replace(",", " ", $class); ?>" href="<?php echo $pics[$flag]->url; ?>" 
			...
			case "color_box":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					...
					{
						?>
						<a class="<?php echo str_replace(",", " ", $class); ?>" 
						href="<?php echo stripcslashes($pics[$flag]->pic_name); ?>" target="_blank" 
						data-title="<?php echo $image_title . $image_description; ?>" id="ux_img_div_<?php echo $unique_id; ?>">
						<?php
					}
					else
					{
						?>
						<a class="<?php echo str_replace(",", " ", $class); ?> colorbox<?php echo $unique_id;?>" 
						href="<?php echo stripcslashes(GALLERY_BK_THUMB_URL . $pics[$flag]->thumbnail_url); ?>" 
			...
			case "foo_box":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					...
					{
						?>
						<a rel="foobox<?php echo $unique_id;?>" class="<?php echo str_replace(",", " ", $class); ?> foobox" 
						href="<?php echo stripcslashes($pics[$flag]->pic_name); ?>" 
						id="ux_img_div_<?php echo $unique_id; ?>">
						<?php
					}
			...
			case "fancy_box":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					if ($pics[$flag]->video == 1)
					{
						...
						class="<?php echo str_replace(",", " ", $class); ?> fancybox-media<?php echo $unique_id;?>" 
						href="<?php echo stripcslashes($pics[$flag]->pic_name); ?>" 
						data-title="<?php echo $image_title . $image_description; ?>" 
						id="ux_img_div_<?php echo $unique_id; ?>">
						<?php
					...
					else
					{
						?>
						<a rel="fancybox-button" data-fancybox-group="button" 
						class="<?php echo str_replace(",", " ", $class); ?> fancybox-buttons<?php echo $unique_id;?>" 
						href="<?php echo stripcslashes(GALLERY_BK_THUMB_URL . $pics[$flag]->thumbnail_url); ?>" 
						data-title="<?php echo $image_title . $image_description; ?>" 
						id="ux_img_div_<?php echo $unique_id; ?>">
						<?php
			...
			case "lightbox2":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					...
					else
					{
						...
						class="<?php echo str_replace(",", " ", $class); ?>" 
						href="<?php echo stripcslashes(GALLERY_BK_THUMB_URL . $pics[$flag]->thumbnail_url); ?>" 
						data-title="<?php echo $image_title . $image_description; ?>" 
						id="ux_img_div_<?php echo $unique_id; ?>"> 
						<?php
			...
			case "GB_lightbox":
				if ($pics[$flag]->url == "" || $pics[$flag]->url == "undefined" || $pics[$flag]->url == "http://")
				{
					if($pics[$flag]->video == 1)
					{
						...
						class="element <?php echo str_replace(","," ", $class)." ".$class_gb; ?>"
						 ...
						 desc="<?php echo $photoswipe_description;?>" id="ux_img_div_<?php echo $pics[$flag]->pic_id; ?>">
						<?php
					}
					else
					{
						?>
						<a imgpath="<?php echo $pics[$flag]->thumbnail_url; ?>" class="<?php echo str_replace(",", " ", $class)." ".$class_gb; ?>"
						 href="javascript:void(0);" data-title="<?php echo $photoswipe_title;?>"
						 desc="<?php echo $photoswipe_description;?>" id="ux_img_div_<?php echo $pics[$flag]->pic_id; ?>">
						<?php
					}
				...
				{
					?>
					<a class="<?php echo str_replace(",", " ", $class)." ".$class_gb; ?>" href="<?php echo $pics[$flag]->url; ?>"
					 id="ux_img_div_<?php echo $pics[$flag]->pic_id; ?>" target="<?php echo $url_redirect; ?>" 
					data-title="<?php echo $photoswipe_title;?>" desc="<?php echo $photoswipe_description;?>" >
					<?php
				}
			break;
			...
			<div class="blog_gallery margin_thumbs" id="blog_holder<?php echo $unique_id; ?>">
				...
				switch($effect[0])
				{
					case "grayscale":
						?>
						<div class="gallery_grayscale opactiy_thumbs">
							<?php
					break;
					case "blur":
						?>
						<div class="gallery_blur opactiy_thumbs">
						<?php
					break;
					case "sepia":
						?>
						<div class="gallery_sepia opactiy_thumbs">
						<?php
					break;
					case "none":
						?>
						<div class="opactiy_thumbs" >
						<?php
					break;
				}
				if ($pics[$flag]->video == 1){
				?>
					<img
					class="dynamic_css" alt="<?php echo $image_title . $image_description; ?>" 
					imageid="<?php echo $pics[$flag]->pic_id; ?>" 
					id="ux_img_<?php echo $unique_id; ?>" 
					type="video" 
				...
				?>
					...
					id="ux_img_<?php echo $unique_id; ?>" 
					type="image" 
					src="<?php echo stripcslashes(GALLERY_BK_THUMB_URL . $pics[$flag]->thumbnail_url); ?>" 
					style="width:700px"/>
				<?php
				}
				switch($effect[0])
				...
				?>
					<div class="blog_description" id="blog_description_div<?php echo $unique_id; ?>">
						<?php
						echo $ImgTitle . $image_description;
						?>
					</div>
				<?php
				}
