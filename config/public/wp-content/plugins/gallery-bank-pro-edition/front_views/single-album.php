	...
	<div class="gallery-bank-hover-details">
        ...
        if ($gallery_type == "slideshow")
        {
	        ...
	        <div class="imgLiquid dynamic_cover_css" id="<?php echo $unique_id; ?>"
             onclick="view_individual_slideshow_images<?php echo $unique_id; ?>(<?php echo $album->album_id; ?>,<?php echo $unique_id; ?>)">
            <?php
        }
        else
        {
...
<?php
    ...
    ?>
    <div id="show_bank_slideshow_images" style="display:none;">
    </div>
<?php
}
?>