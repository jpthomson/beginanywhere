...
if ($pics[$flag]->video == 1) {
    ?>
    <img alt="<?php echo $image_title.$image_description;?>" imageid="<?php echo $pics[$flag]->pic_id; ?>" id="ux_gb_img_<?php echo $unique_id; ?>" type="video"
         src="<?php echo stripcslashes($pics[$flag]->thumbnail_url); ?>" style="height:<?php echo $thumbnails_height; ?>px;"/>
<?php
} else {
    if ($effect[0] == "hover_rotation") {
        ?>
        <img alt="<?php echo $image_title.$image_description;?>" imageid="<?php echo $pics[$flag]->pic_id; ?>" id="ux_gb_img_<?php echo $unique_id; ?>" type="image"
