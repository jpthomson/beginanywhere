				...
				case "filmstrip":
			        ...
			        ?>
			            ...
			            jQuery("ul#thumb_<?php echo $unique_id;?> #li_<?php echo $unique_id;?>").click(function () {
			                ...
			                var desc = jQuery("<div class=\"filmstrip_description_black\">" + jQuery(img).attr("data-title") + jQuery(img).attr("data-desc") + "</div>").addClass("animated <?php echo $animation_effect;?>");
					...
					jQuery(document).ready(function ()
					{
						(function (FOOBOX, $, undefined) {
						    FOOBOX.o = {
						        ...
						        containerCssClass: "foobox-instance",
						        transitionInSpeed:<?php echo $lightbox_fade_in_time;?>,
						        transitionOutSpeed:<?php echo $lightbox_fade_out_time;?>,
						        deeplinking: {
						            enabled: true, 
						            prefix: "foobox<?php echo $unique_id;?>"
						        },
						        fullscreen: {
						            enabled: true,
						            useAPI: true
						        ...
						        excludes: ".jig-customLink, .nofoobox, .fbx-link",
						        affiliate: {
						            enabled: true
						        },
						        error: "Oops, the image couldn\"t load",
						        slideshow: {
						            enabled: true,
						            autostart:<?php echo $autoplay;?>,
						            timeout:<?php echo $slide_interval * 1000; ?>
						        },
						        preload: false,
						        modalClass: "fbx-arrows-1",
						        videos: {
						            showCaptions: true
						        },
						        html: {
