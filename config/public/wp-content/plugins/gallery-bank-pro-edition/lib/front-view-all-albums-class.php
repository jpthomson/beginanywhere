        ...
        for ($flag = 0; $flag < count($pics); $flag++) {
            ...
            switch ($lightbox_type) {
                ...
                case "GB_lightbox":
					 ...
					 {
                    	?>
                    	<a imgpath="<?php echo $pics[$flag]->pic_name; ?>" class="imgLiquidFill <?php echo $class_gb; ?>" 
					 ...
					 {
					 	?>
                    	<a imgpath="<?php echo $pics[$flag]->thumbnail_url; ?>" class="imgLiquidFill <?php echo $class_gb; ?>" 
                    	href="javascript:void(0);" data-title="<?php echo $photoswipe_title; ?>" 
                    	desc="<?php echo $photoswipe_description;?>" id="ux_img_div_<?php echo $pics[$flag]->pic_id; ?>">
                    	<?php
					 }
